        ...
        <div class="container px-3 mx-auto max-w-6xl 2xl:max-w-7xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-10 dark:text-slate-300 tracking-wide">
                <div class="md:col-span-5">
                    ...
                    <p class="text-lg text-slate-600 dark:text-slate-300">Don't like forms? Then whats app me! <a href="https://wa.me/+6285700825901" target="_blank" class="font-medium text-secondary-500 hover:text-secondary-600 dark:text-secondary-300 dark:hover:text-secondary-400 transition-all duration-300">click here</a></p>
                    <ul class="mt-12 space-y-8">
                        ...
                        <li class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <ul class="flex items-center space-x-2">
                                    <li>
                                        <a href="https://www.facebook.com/ihwan.ihwan.94214?mibextid=rS40aB7S9Ucbxw6v" target="_blank">
                        ...
                        <li class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p><a href="https://maps.app.goo.gl/4dSGaAm3jC2azPN47" target="_blank" class="transition-all duration-300 hover:text-secondary-500 dark:hover:text-secondary-300">Bekasi, Indonesia</a></p>
                            </div>
                        </li>
                    </ul>
                </div>
