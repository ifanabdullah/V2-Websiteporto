...
onMounted(() => {
    typed = new Typed(typedElement.value, {
        strings: ["Front end Developer", "Crafting Digital Experiences"],
        typeSpeed: 50,
        backSpeed: 30,
        backDelay: 5000,
        loop: true,
...
<template>
    ...
    <section id="home" class="relative min-h-[calc(100vh-85px)] overflow-x-clip bg-slate-100 dark:bg-[#0B1120]">
        ...
        <div class="container mx-auto px-3 flex flex-col justify-center items-center min-h-[calc(100vh-85px)] max-w-6xl 2xl:max-w-7xl">
            ...
            >
                I'm <span class="bg-clip-text text-transparent bg-gradient-to-r from-sky-500 to-purple-500 dark:from-sky-400 dark:to-teal-400">Ifan Abdullah</span>
            </h1>
            <h2
                v-motion
                :initial="{
            ...
            >
                <a href="https://github.com/Ifanabdullah" target="_blank" class="group flex items-center space-x-3">
                ...
                <a href="https://www.instagram.com/ifan_ad_/" target="_blank" class="group flex items-center space-x-3">
                    <img class="w-[1.5rem] md:w-[1.7rem]" src="/images/igk.png" alt="Ifan Instagram" />
                    <span class="text-lg group-hover:text-gray-700 dark:group-hover:text-white font-medium transition-all duration-300">Instagram</span>
                </a>
            </div>
