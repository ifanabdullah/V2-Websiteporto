        ...
        <div class="container px-3 mx-auto max-w-6xl 2xl:max-w-7xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-10">
                <div class="md:col-span-5 flex justify-center items-start">
                    <div class="relative">
                        <img class="w-full rounded-lg md:w-[400px] border-8 border-slate-300 dark:border-white h-auto shadow-md" src="/images/ifan.jpg" alt="Ifan Abdullah" />
                        ...
                        <transition name="fade" mode="out-in">
                            <div v-if="currentTab === 1" class="dark:text-slate-200 tracking-wide">
                                <div class="prose dark:prose-invert prose-teal tracking-wide mb-7 text-left md:text-justify">
                                    <p>Hi, This is <strong>Ifan Abdullah</strong></p>
                                    <p>Highly passionate about <strong>Software Development</strong> & <strong>Programming</strong> in general. I am a Full Stack Web Developer with strong focus on Front End Development. For the past <strong>two & a half years</strong> I have worked with multiple clients in various project based work. Currently working with <a target="_blank" href="#">HCM Management</a> as a Accounting & IT Suport.</p>
                            ...
                            <div v-else-if="currentTab === 3" class="dark:text-slate-200 tracking-wide">
                                <Experience designation="Accounting & IT Suport" company="HCM Management" timeline="Oktober 2021 - Present">
                                    <template #description>
                                        <ul>
                                            <li>Develop web applications using Laravel, Go & Vue.js</li>
                                            <li>Create a Sales Journal Report in the system</li>
                            ...
                            <div v-else-if="currentTab === 4" class="dark:text-slate-200 tracking-wide space-y-5">
                                <Education degree="BSc in Computer Science & Engineering" institute="Discoding Bootcamp Purwadhika" timeline="February 2022 - Expected 2023" website="https://www.purwadhika.com/" />
                                <Education degree="S1 in Computer Technology" institute="Universita Terbuka Bandung" timeline="August 2023 - December 2028" />
                            </div>
                        </transition>
                    </div>
                </div>
